...
class Bzotech_Instagram_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Instagram (Global)', 'bw-medxtore-v2' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'slider'	=> esc_html__( 'Slider', 'bw-medxtore-v2' ),
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'action_type_click',
			[
				'label' 	=> esc_html__( 'Action type click', 'bw-medxtore-v2' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
		...
		$this->add_control(
			'media_from',
			[
				'label' 	=> esc_html__( 'Media from', 'bw-medxtore-v2' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'username',
				'options'   => [
					'username'		=> esc_html__( 'Username', 'bw-medxtore-v2' ),
					'media-lib'		=> esc_html__( 'Media library', 'bw-medxtore-v2' ),
				],
			]
		);
		$this->add_control(
			'token', 
			[
				'label' => esc_html__( 'Token', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'number',
			[
				'label' => esc_html__( 'Photos number', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'caption_text_hover', 
			[
				'label' 	=> esc_html__( 'Caption', 'bw-medxtore-v2' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'None', 'bw-medxtore-v2' ),
					'username'		=> esc_html__( 'Username', 'bw-medxtore-v2' ),
					'caption'		=> esc_html__( 'Caption', 'bw-medxtore-v2' ),
				],
			]
		);
		$this->add_control(
			'text_title', 
			[
				'label' => esc_html__( 'Text title', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'label_block' => true,
			]
		...
		$this->add_control(
			'link_title', 
			[
				'label' => esc_html__( 'Link title', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'list_images',
			[
				'label' => esc_html__( 'Add images', 'bw-medxtore-v2' ),
		...
		$this->start_controls_section(
			'section_grid_item',
			[
				'label' => esc_html__( 'Grid Item', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'style' => 'grid',
				]
	...
	public function get_slider_settings() {
		$this->start_controls_section(
			'section_slider',
			[
				'label' => esc_html__( 'Slider Settings', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'style' => 'slider',
				]
