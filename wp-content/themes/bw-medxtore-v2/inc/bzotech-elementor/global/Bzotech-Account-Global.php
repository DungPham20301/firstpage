...
class Bzotech_Account_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Account manager (Global)', 'bw-medxtore-v2' );
	}
	...
	public function login_form($redirect_to = '') {
        ...
        <div class="elbzotech-login-form popup-form active">
            <div class="form-header">
                <h2><?php esc_html_e( 'Sign In','bw-medxtore-v2' ); ?></h2>
                
                <div class="message ms-done ms-default"><?php esc_html_e( 'Registration complete. Please check your email.','bw-medxtore-v2' ); ?></div>
            </div>
            <form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
                <?php do_action( 'woocommerce_login_form_start' ); ?>
                <div class="form-field">
                    <input placeholder="<?php esc_attr_e( 'Username or Email Address','bw-medxtore-v2' ); ?>" type="text" name="log" id="user_login" class="input" size="20" autocomplete="off"/>
                </div>
                <div class="form-field password-input">
                	<input placeholder="<?php esc_attr_e( 'Password','bw-medxtore-v2' ); ?>" type="password" name="pwd" id="user_pass" class="input" value="" size="20" autocomplete="off"/>
                ...
                <div class="submit">
                    <input type="submit" name="wp-submit" class="elbzotech-bt-default elbzotech-bt-full" value="<?php esc_attr_e('Sign In','bw-medxtore-v2'); ?>" />
                ...
                <div class="nav-form flex-wrapper justify_content-space-between align_items-center">
                	<div class="forgetmenot">
	                    ...
	                    <label class="rememberme" for="remembermep"><?php esc_html_e( 'Remember Me','bw-medxtore-v2' ); ?></label>
	                </div>
	                <div class="registerform-lost-pass">
		                <?php if ( get_option( 'users_can_register' ) ) :
		                    echo '<a href="#registerform" class="popup-redirect register-link">'.esc_html__("Register",'bw-medxtore-v2').'</a>';
		                endif;
		                echo '<a href="#lostpasswordform" class="popup-redirect lostpass-link">'.esc_html__("Lost your password?",'bw-medxtore-v2').'</a>';
		                ?>
		            </div>
	            </div>
                ...
                if(class_exists('NextendSocialLogin', false)) {
                	echo '<div class="nextend-social-login"><h3 class="title20 font-medium text-center"><span>'.esc_html__('Or login With','bw-medxtore-v2').'</span></h3>';
	...
	public function register_form($redirect_to = '') {
        ...
        <div class="elbzotech-register-form popup-form">
            <div class="form-header">
                <h2><?php esc_html_e( 'Create an account','bw-medxtore-v2' ); ?></h2>
                <div class="message login_error ms-error ms-default"><?php esc_html_e( 'The user name or email address is not correct.','bw-medxtore-v2' ); ?></div>
                
            </div>
            <form name="registerform" id="registerform" action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
                <?php do_action( 'woocommerce_register_form_start' ); ?>
                <div class="form-field">
                    <input placeholder="<?php esc_attr_e('Username','bw-medxtore-v2') ?>" type="text" name="user_login" id="user_loginr" class="input" value="" size="20" autocomplete="off"/>
                </div>
                <div class="form-field">
                    <input placeholder="<?php esc_attr_e('Email','bw-medxtore-v2') ?>" type="email" name="user_email" id="user_email" class="input" value="" size="25" autocomplete="off"/>
                </div>
                <?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ){ ?>
                    <div class="form-field password-input">
                        <input placeholder="<?php esc_attr_e( 'Password', 'bw-medxtore-v2' ); ?>" type="password" name="password" id="reg_passwordp" autocomplete="new-password" />
                    </div>
                <?php }?>
                <div class="extra-field">
                    <?php 
                ...
                <?php if ( 'no' != get_option( 'woocommerce_registration_generate_password' ) ){ ?>
                    <div id="reg_passmail">
                        <?php esc_html_e( 'Registration confirmation will be emailed to you.','bw-medxtore-v2' ); ?>
                    </div>
                <?php }?>
                <div class="submit"><input type="submit" name="wp-submit" class="elbzotech-bt-default elbzotech-bt-full" value="<?php esc_attr_e('Register','bw-medxtore-v2'); ?>" /></div>
                <?php do_action( 'woocommerce_register_form_end' ); ?>
            </form>

            <div class="nav-form">
                <a href="#loginform" class="popup-redirect login-link"><?php esc_html_e( 'Log in','bw-medxtore-v2' ); ?></a>
                <a href="#lostpasswordform" class="popup-redirect lostpass-link"><?php esc_html_e( 'Lost your password?','bw-medxtore-v2' ); ?></a>
            </div>
        </div>
        <?php
	}
	public function lostpass_form($redirect_to = '') {
        ...
        <div class="elbzotech-lostpass-form popup-form">
            <div class="form-header">
                <h2><?php esc_html_e( 'Reset password','bw-medxtore-v2' ); ?></h2>
                <div class="message ms-default ms-done"><?php esc_html_e( 'Password reset email has been sent.','bw-medxtore-v2' ); ?></div>
                <div class="message login_error ms-error ms-default"><?php esc_html_e( 'The email could not be sent. Possible reason: your host may have disabled the mail function.','bw-medxtore-v2' ); ?></div>
            </div>
            <form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( network_site_url( 'wp-login.php?action=lostpassword', 'login_post' ) ); ?>" method="post">
                <div class="form-field">
                    <input placeholder="<?php esc_attr_e( 'Username or Email Address','bw-medxtore-v2' ); ?>" type="text" name="user_login" id="user_loginlp" class="input" value="" size="20" autocomplete="off"/>
                </div>
                <div class="extra-field">
                    <?php do_action( 'lostpassword_form' ); ?>
                    <input type="hidden" name="redirect_to1" value="<?php echo esc_attr( $redirect_to ); ?>" />
                </div>
                <div class="submit"><input type="submit" name="wp-submit" class="elbzotech-bt-default elbzotech-bt-full" value="<?php esc_attr_e('Get New Password','bw-medxtore-v2'); ?>" /></div>
                <div class="desc note"><?php esc_html_e( 'A password will be e-mailed to you.','bw-medxtore-v2' ); ?></div>
            </form>
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'default',
				'options'   => [
					'default'		=> esc_html__( 'Style 1 (Default)', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'icon_logged',
			[
				'label' => esc_html__( 'Icon logged', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
					'value' => 'fas fa-user',
					'library' => 'solid',
		...
		$this->start_controls_section(
			'section_links',
			[
				'label' => esc_html__( 'Sub links dropdown', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$repeater_text->add_control(
			'roles',
			[
				'label' => esc_html__( 'Show with roles', 'bw-medxtore-v2' ),
				'description' => esc_html__( 'Choose roles to show. Default is show with all roles', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'list_links',
			[
				'label' => esc_html__( 'Add links', 'bw-medxtore-v2' ),
		...
		$this->start_controls_section(
			'section_style_links',
			[
				'label' => esc_html__( 'Links', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
	...
	public function get_style_type_icon($key='icon',$class="item-icon-e") {
		...
		$this->add_responsive_control(
			$key.'_transition_css',
			[
				'label' => esc_html__( 'Transition', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
