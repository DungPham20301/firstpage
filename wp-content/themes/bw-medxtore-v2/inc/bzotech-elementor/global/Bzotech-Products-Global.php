...
class Bzotech_Products_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products list (Global)', 'bw-medxtore-v2' );
	}
        ...
        if($display_tab !== '' && is_array($tabs) && count($tabs) >=1){
        	...
        	foreach ($tabs as $key => $tab) {
		        ...
		        if(!empty($icon_image['url'])){
					...
					if( $icon['library'] == 'svg')
						$tab_icon_html .= '<img alt="'.esc_attr__('svg','bw-medxtore-v2').'" src="'.esc_url($icon['value']['url']).'">';
					else
        		...
        		if ( !empty( $link_view_tab['url']) ) { 
					...
					$tab_content_html .='<a class = "link-view-tab font-semibold elbzotech-bt-global-style3  " '.$this->get_render_attribute_string( 'link_view_tab'.$key ).' ><span class="text-button">'.esc_html__('View All', 'bw-medxtore-v2').'</span><i class="las la-long-arrow-alt-right title18"></i></a>';
				}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'elbzotech-product-grid'		=> esc_html__( 'Grid', 'bw-medxtore-v2' ),
					'elbzotech-product-list'		=> esc_html__( 'List', 'bw-medxtore-v2' ),
					'elbzotech-product-slider'		=> esc_html__( 'Slider', 'bw-medxtore-v2' ),
					'elbzotech-product-grid-masory'		=> esc_html__( 'Grid Masory', 'bw-medxtore-v2' ),
				],
			]
		);
		...
		$this->add_control( 
			'display_tab',
			[
				'label' => esc_html__( 'Display tab', 'bw-medxtore-v2' ),
				'type'      => Controls_Manager::SELECT,
				'default' => '',
				'options'   => [
					''		=> esc_html__( 'Off', 'bw-medxtore-v2' ),
					'style1'		=> esc_html__( 'Style 1 (home 15)', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'item_quickview',
			[
				'label' => esc_html__( 'Quick View', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'item_rate',
			[
				'label' => esc_html__( 'Rate', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'item_countdown',
			[
				'label' => esc_html__( 'Show countdown price', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'item_brand',
			[
				'label' => esc_html__( 'Show Brand', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'item_gallery_hover',
			[
				'label' => esc_html__( 'Show Gallery Images', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'item_flash_sale',
			[
				'label' => esc_html__( 'Flash Sale', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options'   => [
					''		=> esc_html__( 'Default', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
                    ...
                    'menu_order' 	=> esc_html__('Menu order','bw-medxtore-v2'),
                    'flash_sale' 	=> esc_html__('Flash Sale','bw-medxtore-v2'),
				],
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'List setting', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Style 1 - default', 'bw-medxtore-v2' ),
				],
			]
		);
		$this->add_control(
			'excerpt_list',
			[
				'label' => esc_html__( 'Excerpt list', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 0,
				'max' => 1000,
				'step' => 1,
		...
		$this->start_controls_section(
			'section_filter',
			[
				'label' => esc_html__( 'Filter Button', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'filter-col'		=> esc_html__( 'Style 2', 'bw-medxtore-v2' ),
					'filter-col filter-col-list'	=> esc_html__( 'Style 3', 'bw-medxtore-v2' ),
				],
				'condition' => [
					'filter_show' => 'yes',
				]
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					'filter-2-col'				=> esc_html__( '2 Column', 'bw-medxtore-v2' ),
					'filter-3-col'				=> esc_html__( '3 Column', 'bw-medxtore-v2' ),
					'filter-4-col'				=> esc_html__( '4 Column', 'bw-medxtore-v2' ),
				],
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Categories', 'bw-medxtore-v2' ),
				'description' => esc_html__( 'Enter slug categories. The values separated by ",". Example cat-1,cat-2', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'bw-medxtore-v2' ),
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->add_control(
			'filter_attr', 
			[
				'label' => esc_html__( 'Attributes', 'bw-medxtore-v2' ),
				'description' => esc_html__( 'Enter slug attributes. The values separated by ",". Example attribute-1,attribute-2', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'cat-1,cat-2', 'bw-medxtore-v2' ),
				'condition' => [
					'filter_show' => 'yes',
		...
		$this->start_controls_section(
			'section_tab',
			[
				'label' => esc_html__( 'Tab', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'display_tab!' => '',
				]
		...
		$repeater->add_control(
			'title', [
				'label' => esc_html__( 'Title', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab Title' , 'bw-medxtore-v2' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			'link_view_tab',
			[
				'label' => esc_html__( 'Link view', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Add tab', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'price_regular',
			[
				'label' => esc_html__( 'Regular', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'price_sale',
			[
				'label' => esc_html__( 'Sale', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_tab( 'section_label_new',
			[
				'label' => esc_html__( 'Label New', 'bw-medxtore-v2' ),
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab( 'section_label_sale',
			[
				'label' => esc_html__( 'Label Sale', 'bw-medxtore-v2' ),
			]
		);
		...
		$this->add_control(
			'bg_image_tab',
			[
				'label' => esc_html__( 'Background image', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_responsive_control(
			'tab_item_width',
			[
				'label' => esc_html__( 'Item width', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_responsive_control(
			'tab_item_height',
			[
				'label' => esc_html__( 'Item height', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	...
	public function get_slider_masory_settings() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Masory settings', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
		...
		$this->add_control(
			'slider_items_group',
			[
				'label' => esc_html__( 'Group item products', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::NUMBER,
				'description'	=> esc_html__( 'Group the number of products into 1  item of slider', 'bw-medxtore-v2' ),
				'min' => 1,
				'max' => 20,
				'step' => 1,
				'default' => 1,
		...
		$this->add_responsive_control(
			'space_item',
			[
				'label' => esc_html__( 'Space item (px)', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$default_template = [
					'style1'		=> esc_html__( 'Style 1 (Replace)', 'bw-medxtore-v2' ),
					'style2'		=> esc_html__( 'Style 2 (Replace)', 'bw-medxtore-v2' ),
					'style3'		=> esc_html__( 'Style 3 (Replace)', 'bw-medxtore-v2' ),
					'style5'		=> esc_html__( 'Style 5 (Replace)', 'bw-medxtore-v2' ),
				];
		$repeater_masory->add_control(
			'template',
			[
				'label' 	=> esc_html__( 'Replace style or Insert template', 'bw-medxtore-v2' ),
				'description'	=> esc_html__( 'Replace the display style or insert content in the template', 'bw-medxtore-v2' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '',
		...
		$this->add_control(
			'list_grid_custom',
			[
				'label' => esc_html__( 'Add layout masory', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::REPEATER,
				'prevent_empty'=>false,
	...
	public function get_slider_settings() {
		...
		$this->add_control(
			'slider_column',
			[
				'label' => esc_html__( 'Row', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 1,
				'max' => 10,
				'step' => 1,
	...
	public function get_box_settings($key='box-key',$class="box-class") {
		...
		$this->add_responsive_control(
			$key.'_padding_wrap',
			[
				'label' => esc_html__( 'Padding Column', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', ],
				'selectors' => [
	...
	public function get_slider_styles() {
		...
		$this->add_control(
			'slider_text_next',
			[
				'label' => esc_html__( 'Text next', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Next', 'bw-medxtore-v2' ),
			]
		);
		...
		$this->add_control(
			'slider_text_prev',
			[
				'label' => esc_html__( 'Text prev', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Prev', 'bw-medxtore-v2' ),
			]
		);
		$this->add_responsive_control(
			'slider_icon_size',
