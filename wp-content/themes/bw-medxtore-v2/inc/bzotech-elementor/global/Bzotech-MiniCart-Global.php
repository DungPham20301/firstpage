...
class Bzotech_MiniCart_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Mini Cart (Global)', 'bw-medxtore-v2' );
	}
	...
	public function mini_cart($image_size='') {
		...
		if ( ! \WC()->cart->is_empty() ) : do_action( 'woocommerce_before_mini_cart' ); ?>
		    ...
		    <div class="mini-cart-footer">
			    <div class="mini-cart-total clearfix">
			        <span class="pull-left"><?php esc_html_e( 'Total', 'bw-medxtore-v2' ); ?></span>
		...
		<?php do_action( 'woocommerce_after_mini_cart' ); else : ?>
		    ...
		    <div class="mini-cart-empty"><?php esc_html_e( 'No products in the cart.', 'bw-medxtore-v2' ); ?></div>
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'style1',
				'options'   => [
					'style1'		=> esc_html__( 'Style default', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'style_content',
			[
				'label' 	=> esc_html__( 'Content Style', 'bw-medxtore-v2' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'dropdown',
				'options'   => [
					'dropdown'		=> esc_html__( 'Dropdown', 'bw-medxtore-v2' ),
					'side-right'		=> esc_html__( 'Side right', 'bw-medxtore-v2' ),
					'side-left'		=> esc_html__( 'Side left', 'bw-medxtore-v2' ),
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'show_price',
			[
				'label' => esc_html__( 'Show price', 'bw-medxtore-v2' ),
		...
		$this->start_controls_section(
			'section_style_icon',
			[
				'label' => esc_html__( 'Style box cart', 'bw-medxtore-v2' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style box label and price cart', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Direction Text', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::CHOOSE,
				'responsive' => true,
				'options' => [
					'column' => [
						'title' => esc_html_x( 'Column', 'Flex Container Control', 'bw-medxtore-v2' ),
						'icon' => 'eicon-flex  eicon-align-stretch-h',
					],
					'row' => [
						'title' => esc_html_x( 'Row', 'Flex Container Control', 'bw-medxtore-v2' ),
						'icon' => 'eicon-flex  eicon-align-stretch-v',
					],
				],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style elementor cart', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'color_label',
			[
				'label' => esc_html__( 'Label Color', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'color_cart_number',
			[
				'label' => esc_html__( 'Cart number color', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'color_price',
			[
				'label' => esc_html__( 'Price Color', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography Label', 'bw-medxtore-v2' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography Price', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'color_label_hover',
			[
				'label' => esc_html__( 'Label Color Hover', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'color_price_hover',
			[
				'label' => esc_html__( 'Price Color Hover', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Cart number color hover', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography Label Hover', 'bw-medxtore-v2' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography Price Hover', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'color_number',
			[
				'label' => esc_html__( 'Color number', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'pos_left_number',
			[
				'label' => esc_html__( 'Position right', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' , '%'],
				'range' => [
					'px' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Dropdown/side', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title Typography', 'bw-medxtore-v2' ),
		...
		$this->add_responsive_control(
			'dropdown_pos',
			[
				'label' => esc_html__( 'Dropdown position', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::CHOOSE,
				'default'	=> '',
				'options' => [
					'left' => [
					...
					'center' => [
						'title' => esc_html__( 'Inherit', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Background overlay', 'bw-medxtore-v2' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Footer side', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'style_content' => ['side-left','side-right'],
				]
		...
		$this->add_responsive_control(
			'footer_text_space',
			[
				'label' => esc_html__( 'Space text', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
