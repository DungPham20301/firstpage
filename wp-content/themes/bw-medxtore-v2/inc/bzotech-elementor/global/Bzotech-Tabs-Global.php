...
class Bzotech_Tabs_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Tab (Global)', 'bw-medxtore-v2' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'options'   => [
					''		=> esc_html__( 'Style 1 (Basic)', 'bw-medxtore-v2' ),
				],
			]
		);
		$this->add_control(
			'title_header',
			[
				'label' => esc_html__( 'Title header', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( '', 'bw-medxtore-v2' ),
				'placeholder' => esc_html__( 'Title header', 'bw-medxtore-v2' ),
				'label_block' => true,
		...
		$repeater->add_control(
			'tab_title',
			[
				'label' => esc_html__( 'Title & Description', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Tab Title', 'bw-medxtore-v2' ),
				'placeholder' => esc_html__( 'Tab Title', 'bw-medxtore-v2' ),
				'label_block' => true,
			]
		);
		$repeater->add_control(
			'icon',
			[
				'label' => esc_html__( 'Icon title', 'bw-medxtore-v2' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Content', 'bw-medxtore-v2' ),
				'default' => esc_html__( 'Tab Content', 'bw-medxtore-v2' ),
				'placeholder' => esc_html__( 'Tab Content', 'bw-medxtore-v2' ),
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Tabs Items', 'bw-medxtore-v2' ),
				'type' => Controls_Manager::REPEATER,
				'prevent_empty'=>false,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Tab #1', 'bw-medxtore-v2' ),
						'tab_content'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'bw-medxtore-v2' ),
					],
					[
						'tab_title' => esc_html__( 'Tab #2', 'bw-medxtore-v2' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'bw-medxtore-v2' ),
					],
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Section Style', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->start_controls_section(
			'section_header_tab',
			[
				'label' => esc_html__( 'Header Tab', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);  
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header tab list item', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);  
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header tab item', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);  
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content tab', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);  
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header title', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'title_header!' =>  '',
				]
		...
		$this->start_controls_section(
			'style_header_title',
			[
				'label' => esc_html__( 'Style header title', 'bw-medxtore-v2' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style tab item', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);  
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style icon image', 'bw-medxtore-v2' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);  
	...
	public function get_style_type_text($key='text',$class="item-text-e", $class_active='') {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => esc_html__( 'Justify', 'bw-medxtore-v2' ),
		...
		if(!empty($class_active)){
			$this->start_controls_tab(
				$key.'_tab_active_css',
				[
					'label' => esc_html__( 'Style On Active', 'bw-medxtore-v2' ),
				]
			);
			$this->add_control(
