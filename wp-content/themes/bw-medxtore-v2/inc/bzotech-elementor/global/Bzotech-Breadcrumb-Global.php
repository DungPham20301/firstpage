...
class Bzotech_Breadcrumb_Global extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Breadcrumb (Global)', 'bw-medxtore-v2' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_item_style',
			[
				'label' => esc_html__( 'Style item breadcrumb', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style step breadcrumb', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Style item breadcrumb last child', 'bw-medxtore-v2' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
