...
if(!class_exists('Bzotech_Category_Fillter') && class_exists("woocommerce"))
{
    class Bzotech_Category_Fillter extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( false, esc_html__('BZOTECH Categories Filter','bw-medxtore-v2'),
                array( 'description' => esc_html__( 'Filter product shop page', 'bw-medxtore-v2' ), ));
        ...
        function form( $instance ) {
            ...
            <p>
                <label><?php esc_html_e( 'Categories:' ,'bw-medxtore-v2'); ?></label></br>
                <?php 
                ...
                else echo esc_html__("No any category.",'bw-medxtore-v2');
                ?>
            </p>            
        <?php
        }
