...
if(!class_exists('Bzotech_WG_Get_Mega_Page'))
{
    class Bzotech_WG_Get_Mega_Page extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( false, esc_html__('BZOTECH Get Mega Page','bw-medxtore-v2'),
                array( 'description' => esc_html__( 'Get content in mega page', 'bw-medxtore-v2' ), ));
        ...
        function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'page_id' )); ?>"><?php esc_html_e( 'Select mega page:' ,'bw-medxtore-v2'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'el_class' )); ?>"><?php esc_html_e( 'Wrap class:' ,'bw-medxtore-v2'); ?></label>
