    ...
    class Bzotech_Woocommerce_Attributes{
        ...
        static function bzotech_product_option_terms_attribute( $taxonomy, $index ) {
            $types = array(
                ...
                'image' => esc_html__( 'Image', 'bw-medxtore-v2' ),
            ...
            <select multiple="multiple" data-placeholder="<?php esc_attr_e( 'Select terms', 'bw-medxtore-v2' ); ?>" class="multiselect attribute_values wc-enhanced-select" name="attribute_values[<?php echo esc_attr($index); ?>][]">
                <?php
            ...
            <button class="button plus select_all_attributes"><?php esc_html_e( 'Select all', 'bw-medxtore-v2' ); ?></button>
            <button class="button minus select_no_attributes"><?php esc_html_e( 'Select none', 'bw-medxtore-v2' ); ?></button>
            <button class="button fr plus tawcvs_add_new_attribute" data-type="<?php echo esc_attr($taxonomy->attribute_type); ?>"><?php esc_html_e( 'Add new', 'bw-medxtore-v2' ); ?></button>
                ...
                case 'image':
                    ...
                    <div class="wrap-metabox">
                        <div class="live-previews" data-image="<?php echo esc_attr($image_default)?>">
                            <img  alt= "<?php echo esc_attr__('image','bw-medxtore-v2'); ?>" src="<?php echo esc_url($image)?>"/>
                        </div>
