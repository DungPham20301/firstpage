...
if(!class_exists('Bzotech_BaseController')){
    class Bzotech_BaseController{
         ...
         * */
         static function bzotech_remove_archive_title($title) {
            if (is_category()) {
                ...
                $title = sprintf(esc_html__('%1$s','bw-medxtore-v2'), single_term_title('', false));
                ...
                foreach($add_sidebars as $sidebar){
                    ...
                    if(!empty($sidebar['title'])){
                        ...
                        $custom_add_sidebar = array(
                                'name' => $sidebar['title'],
                                'id' => $id,
                                'description' => esc_html__( 'SideBar created by add sidebar in theme options.', 'bw-medxtore-v2'),
        ...
        static function _add_scripts(){
            ...
            wp_enqueue_style('bzotech-swiper',$css_url_global.'lib/swiper.css');
            ...
            if ( class_exists( '\Elementor\Plugin' ) ) {
                ...
                $array_id_page[]  = bzotech_get_value_by_id('append_content_summary');
            ...
            if(!empty($css_element_global) && is_array($css_element_global))
                foreach($css_element_global as $filename){
                    ...
                    if(!empty($dirname['filename'])){
                        $name =  $dirname['filename'];
                        wp_enqueue_style('bzotech-global-'.$name,$css_url_global.'elementor/'.$name.'.css',array(),$bzotech_config['theme_version']);
                    }
        ...
        static function bzotech_metabox_register($tag) { 
            ...
            <div class="form-field">
                <label><?php esc_html_e('Show banner','bw-medxtore-v2'); ?></label>
                <div class="wrap-metabox">
                    <select name="show_banner_list_post" id="show_banner_list_post">
                        <option value=""><?php esc_html_e("Choose by theme option",'bw-medxtore-v2')?></option>
                        <option value="1"><?php esc_html_e("Show",'bw-medxtore-v2')?></option>
                        <option value="0"><?php esc_html_e("Hidden",'bw-medxtore-v2')?></option>
                    </select>
                </div>
            </div>
            <div class="form-field">
                <label><?php esc_html_e('Background banner','bw-medxtore-v2'); ?></label>
                <div class="wrap-metabox">
            ...
            <div class="form-field">
                <label><?php esc_html_e('Link banner','bw-medxtore-v2'); ?></label>
                <input name="link_banner_list_post" type="text" value="" size="40">
            </div>
            <div class="form-field">
                <label><?php esc_html_e('Content banner','bw-medxtore-v2'); ?></label>
                <textarea name="content_banner_list_post" cols="50" rows="5"></textarea>
            </div>
            <div class="form-field">
                <label><?php esc_html_e('Append Content Before','bw-medxtore-v2'); ?></label>
                <div class="wrap-metabox">
                    <select name="before_append" id="before_append">
                        <option value=""><?php esc_html_e("Choose page",'bw-medxtore-v2')?></option>
                        <?php
            ...
            <div class="form-field">
                <label><?php esc_html_e('Append Content After','bw-medxtore-v2'); ?></label>
                <div class="wrap-metabox">
        ...
        static function bzotech_metabox_edit($tag) { ?>
                ...
                <td>            
                    <div class="wrap-metabox">
                        <select name="show_banner_list_post" id="show_banner_list_post">
                            ...
                            <option value=""><?php esc_html_e("Choose by theme option",'bw-medxtore-v2')?></option>
                            <option <?php echo selected('1',$show_banner_list_post,false); ?> value="1"><?php esc_html_e("Show",'bw-medxtore-v2')?></option>
                            <option <?php echo selected('0',$show_banner_list_post,false); ?> value="0"><?php esc_html_e("Hidden",'bw-medxtore-v2')?></option>
                        </select>
                    </div>            
                </td>
            </tr>
            ...
            <tr class="form-field">
                <th scope="row"><label><?php esc_html_e('Link banner','bw-medxtore-v2'); ?></label></th>
                <td>
                    <input name="link_banner_list_post" type="text" value="<?php echo get_term_meta($tag->term_id, 'link_banner_list_post', true)?>" size="40">
                </td>
            </tr>        
            <tr class="form-field">
                <th scope="row"><label><?php esc_html_e('Content banner','bw-medxtore-v2'); ?></label></th>
                <td>
