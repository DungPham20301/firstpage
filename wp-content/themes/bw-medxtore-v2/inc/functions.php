...
if(!function_exists('bzotech_list_post_type')){
    function bzotech_list_post_type($post_type = 'page',$add_empty = false,$default=array(),$admin=true){
        ...
        $post_temp = $post;
        $page_list = array();
        if($add_empty) $page_list[''] = esc_html__('-- Choose One --','bw-medxtore-v2');
...
if ( !function_exists( 'bzotech_get_google_link' ) ) {
    function bzotech_get_google_link($fonts=null) {
        $fonts_list2 = $font1 ='';
        $fonts_list  = 'Urbanist:400,500,600,700,800,900';
        if(!empty($fonts) && is_array($fonts)){
            $step ='|';
            $dem =0;
            foreach ($fonts as $key => $value) {
                $fonts_add = explode(',', $value);
                if('Urbanist' !== $fonts_add[0]){
                    if($key == 0){
                        $font1 = $fonts_add[0];
        ...
        if ( 'off' !== _x( 'on', 'Google font: on or off', 'bw-medxtore-v2' ) ) {
...
if(!function_exists('bzotech_get_value_by_id')){   
    function bzotech_get_value_by_id($key,$meta_empty = false){
        if(!empty($key)){
            ...
            if(empty($value) && !$meta_empty) $value = bzotech_get_option($key);
        ...
        else return esc_html__('Missing a variable of this funtion','bw-medxtore-v2');
    }
}
                ...
                switch ($preload_style) {
                    ...
                    case 'custom-image':
                        ...
                        <div id="loading-center-absolute-image">
                            <img src="<?php echo esc_url($preload_img)?>" alt="<?php esc_attr_e("preload-image",'bw-medxtore-v2');?>"/>
                        </div>
                        <?php
                        break;
...
if(!function_exists('bzotech_get_sidebar_list')){
    function bzotech_get_sidebar_list(){
        ...
        $sidebars = array(
            esc_html__('--Select--','bw-medxtore-v2') => ''
            );
                            ...
                            switch ($value) {
                                    ...
                                    if($tags):?>
                                        <li class="post-meta-data__item meta-tags">
                                            <div class="post-meta-data__content">
                                                ...
                                                <?php if($tags) echo apply_filters('bzotech_output_content',$tags); else esc_html_e("No Tag",'bw-medxtore-v2');?>
                                            </div>
                                            <?php if($key < (count($data)-1)) echo '<span class="split">'.$split.'</span>';?>
                                        </li>
                                    <?php endif;
                                    ...
                                    <li class="post-meta-data__item comments-item">
                                        <div class="post-meta-data__content">
                                            ...
                                            <a href="<?php echo esc_url( get_comments_link() ); ?>"><?php echo get_comments_number(); ?> 
                                                <span>
                                                <?php 
                                                    if(get_comments_number() != 1) esc_html_e('Comments', 'bw-medxtore-v2') ;
                                                    else esc_html_e('Comment', 'bw-medxtore-v2') ;
                                                ?>
                                                </span>
                                            </a>
                                        </div>
                                ...
                                default:
                                    ...
                                    <li class="post-meta-data__item avata">
                                        <div class="post-meta-data__content">
                                            <i class="las la-user"></i><?php echo esc_html__('By: ','bw-medxtore-v2');?>
                        ...
                        <div class="flex-wrapper align-content-center justify_content-space-between">
                            ...
                            if ($tags):
                                ...
                                <div class="tags-post-wrap flex-wrapper">
                                    <span class="tags-and-share-title"><?php esc_html_e('Tag', 'bw-medxtore-v2') ; ?></span>
                                    <div class="tags-post">
                            ...
                            <?php if ((isset($check_share[$post_type]) && $check_share[$post_type] == '1')) { ?>
                                <div class="single-post-share-wrap flex-wrapper">
                                    <span class="tags-and-share-title"><?php esc_html_e('Share', 'bw-medxtore-v2') ; ?></span>
                                    <?php
                        ...
                        foreach ($data as $key => $value) {
                            switch ($value) {
                                    ...
                                    if($tags):?>
                                        <li class="post-meta-data__item meta-tags">
                                            <div class="post-meta-data__content">
                                                ...
                                                <?php if($tags) echo '<div class="flex-wrapper flex_wrap-wrap align_items-center">'.apply_filters('bzotech_output_content',$tags); else esc_html_e("No Tag",'bw-medxtore-v2').'</div>';?>
                                            </div>
                                            <?php if($key < (count($data)-1)) echo '<span class="split">'.$split.'</span>';?>
                                        </li>
                                    <?php endif;
                                ...
                                case 'views':
                                    ...
                                    <li class="post-meta-data__item meta-views">
                                        <div class="post-meta-data__content">
                                            ...
                                            <span>
                                                <?php echo bzotech_get_post_view(). ' ';
                                                if(bzotech_get_post_view() != 1) echo esc_html__("Views",'bw-medxtore-v2');
                                                else echo esc_html__("View",'bw-medxtore-v2');
                                                ?>
                                            </span>
                                        </div>
                                        <?php if($key < (count($data)-1)) echo '<span class="split">'.$split.'</span>';?>
                                ...
                                default:
                                    ...
                                    <li class="post-meta-data__item avata">
                                        <div class="post-meta-data__content">
                                            <i class="fa fa-user"></i><?php echo esc_html__('By: ','bw-medxtore-v2');?>
                                            <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>">                                                                                        
                                                <span class="name"><?php echo get_the_author(); ?></span>
...
if(!function_exists('bzotech_get_post_list_style')){
    function bzotech_get_post_list_style(){
        $list = apply_filters('bzotech_post_list_item_style',array(
            ...
            'style2' => esc_html__('Post list 2','bw-medxtore-v2'),
            ));        
        return $list;
    }
}
...
if(!function_exists('bzotech_get_post_style')){
    function bzotech_get_post_style(){
        $list = apply_filters('bzotech_post_item_style',array(
             '' => esc_html__('Default','bw-medxtore-v2'),
            'style2' => esc_html__('Style 2 (Demo 2)','bw-medxtore-v2'),
            'style3' => esc_html__('Style 3 (Demo 3)','bw-medxtore-v2'),
            'style4' => esc_html__('Style 4 (Demo 5)','bw-medxtore-v2'),
            'style5' => esc_html__('Style 5 (Demo 7)','bw-medxtore-v2'),
            'style6' => esc_html__('Style 6 (Demo 9)','bw-medxtore-v2'),
            /*'style7' => esc_html__('Style 7 (Demo 10)','bw-medxtore-v2'),
            'style8' => esc_html__('Style 8 (Demo 11)','bw-medxtore-v2'),
            'style9' => esc_html__('Style 9 (Demo 12)','bw-medxtore-v2'),*/         
            'style10' => esc_html__('Style 7 (Demo 13)','bw-medxtore-v2'),
            'style11' => esc_html__('Style 8 (Demo 15,16)','bw-medxtore-v2'),
            ));
...
if(!function_exists('bzotech_get_product_thumb_animation')){
    function bzotech_get_product_thumb_animation(){
        $list = apply_filters('bzotech_product_item_style',array(
            ...
            'zoom-thumb'        => esc_html__('Zoom','bw-medxtore-v2'),
            'rotate-thumb'      => esc_html__('Rotate','bw-medxtore-v2'),
            'zoomout-thumb'     => esc_html__('Zoom Out','bw-medxtore-v2'),
            'translate-thumb'   => esc_html__('Translate','bw-medxtore-v2'),
            ));
        return $list;
    }
}
...
if(!function_exists('bzotech_get_thumb_animation')){
    function bzotech_get_thumb_animation(){
        $list = apply_filters('bzotech_thumb_animation',array(
            ...
            'overlay-image zoom-image'  => esc_html__("Overlay Zoom",'bw-medxtore-v2'),
...
if(!function_exists('bzotech_get_product_style')){
    function bzotech_get_product_style($data = ''){
        $list = apply_filters('bzotech_product_item_style',array(
            ...
            'style8'    => esc_html__('Style 8','bw-medxtore-v2'),
            'style9'    => esc_html__('Style 9','bw-medxtore-v2'),
            'style10'   => esc_html__('Style 10','bw-medxtore-v2'),
            'style11'   => esc_html__('Style 11','bw-medxtore-v2'),
            'style12'   => esc_html__('Style 12','bw-medxtore-v2'),
            'style13'   => esc_html__('Style 13','bw-medxtore-v2'),
            'style14'   => esc_html__('Style 14','bw-medxtore-v2'),
            'style15'   => esc_html__('Style 15','bw-medxtore-v2'),
            ));
...
if(!function_exists('bzotech_get_order_list')){
    function bzotech_get_order_list($current=false,$extra=array(),$return='array'){
        $default = array(
            esc_html__('None','bw-medxtore-v2')               => 'none',
            esc_html__('ID','bw-medxtore-v2')                 => 'ID',
            esc_html__('Author','bw-medxtore-v2')             => 'author',
            esc_html__('Title','bw-medxtore-v2')              => 'title',
            esc_html__('Name','bw-medxtore-v2')               => 'name',
            esc_html__('Date','bw-medxtore-v2')               => 'date',
            esc_html__('Last Modified Date','bw-medxtore-v2') => 'modified',
            esc_html__('Post Parent','bw-medxtore-v2')        => 'parent',
        );
...
if(!function_exists('bzotech_breadcrumb')){
    function bzotech_breadcrumb($step = '',$class_item='') {
        ...
        if(is_home() && !is_front_page()) echo '<a class="'.$class_item.'" href="'.esc_url(home_url('/')).'">'.esc_html__('Home','bw-medxtore-v2').'</a>'.$step.'<span  class="'.$class_item.'" >'.esc_html__('Blog','bw-medxtore-v2').'</span>';
        else echo '<a class="'.$class_item.'" href="'.esc_url(home_url('/')).'">'.esc_html__('Home','bw-medxtore-v2').'</a>';
        if (is_single()){
        ...
        elseif(is_search()) echo apply_filters('bzotech_output_content',$step).'<span class="'.$class_item.'">'.esc_html__('Search Results for: ','bw-medxtore-v2').get_search_query().'</span>';
        elseif(is_404()) echo apply_filters('bzotech_output_content',$step).'<span class="'.$class_item.'">'.esc_html__('404','bw-medxtore-v2').'</span>';
    }
}
...
if(!function_exists('bzotech_list_class_style_by_theme')){
    function bzotech_list_class_style_by_theme() {
        $array = [
            'e-main-color'    => esc_html__( 'Main color', 'bw-medxtore-v2' ),
            'e-main-color2'   => esc_html__( 'Main color 2', 'bw-medxtore-v2' ),
            'e-main-color-darken'    => esc_html__( 'Main color darken', 'bw-medxtore-v2' ),
            'e-bg-color'      => esc_html__( 'Background color', 'bw-medxtore-v2' ),
            'e-bg-color2'     => esc_html__( 'Background color 2', 'bw-medxtore-v2' ),
            'e-bg-color-darken'     => esc_html__( 'Background color darken', 'bw-medxtore-v2' ),
            'e-bg-color-lighten'     => esc_html__( 'Background color lighten', 'bw-medxtore-v2' ),
            'e-bg-color-title'     => esc_html__( 'Background color title', 'bw-medxtore-v2' ),
            'e-bg-color-title2'     => esc_html__( 'Background color title2', 'bw-medxtore-v2' ),
            'e-color-body'    => esc_html__( 'Color body', 'bw-medxtore-v2' ),
            'e-color-title'   => esc_html__( 'Color title', 'bw-medxtore-v2' ),
            'e-color-white'   => esc_html__( 'Color white', 'bw-medxtore-v2' ),
            'e-color-gray'   => esc_html__( 'Color gray', 'bw-medxtore-v2' ),
            'e-font-body'   => esc_html__( 'Font body', 'bw-medxtore-v2' ),
            'e-font-title'   => esc_html__( 'Font title', 'bw-medxtore-v2' ),
        ];
...
if(!function_exists('bzotech_list_class_style_hover_by_theme')){
    function bzotech_list_class_style_hover_by_theme() {
        $array = [
            'hover-e-main-color'    => esc_html__( 'Hover main color', 'bw-medxtore-v2' ),
            'hover-e-main-color-darken'    => esc_html__( 'Hover main color darken', 'bw-medxtore-v2' ),
            'hover-e-main-color2'   => esc_html__( 'Hover main color 2', 'bw-medxtore-v2' ),
            'hover-e-color-body'    => esc_html__( 'Hover color body', 'bw-medxtore-v2' ),
            'hover-e-color-title'   => esc_html__( 'Hover color title', 'bw-medxtore-v2' ),
            'hover-e-color-gray'   => esc_html__( 'Hover color gray', 'bw-medxtore-v2' ),
        ];
