                ...
                echo '<div '.$wdata->get_render_attribute_string( 'elbzotech-item-slider-'.$style.'-'.$key ).'><div class="  item-slider-global-'.$style.'">';
                   $link_html = $title_html =$desc_html = $image_html =$count_html ='';
                    ...
                    if(!empty($item['template'])) 
                       ...
                       echo '<a class="cate-item flex-wrapper align_items-center " '.$link_html.'><span class="adv-thumb-link" >'.$image_html.' </span>
                            <h2 class="info-title  font-medium title26">'.$title_html.'</h2></a>';
                    }  
