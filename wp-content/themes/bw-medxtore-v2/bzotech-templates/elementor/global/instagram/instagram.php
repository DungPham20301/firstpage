            ...
            if(!empty($media_array) && is_array($media_array)){
                foreach ($media_array as $item) {
                    if(!empty($item['media_url'])){
                    	...
                    	echo '<a href="'.esc_url($item['permalink']).'" rel="nofollow" class="img-wrap adv-thumb-link overflow-hidden"><img alt="'.esc_attr__('instagram','bw-medxtore-v2').'" src="'.esc_url($item['media_url']).'"/></a>';
