		...
		<div class="elbzotech-banner-info-global-thumb <?php echo esc_attr($image_effect_banner.' '.$box_overflow); ?>" >
            ...
            if(!empty($image['url'])){
             ...
             echo '<a class="adv-thumb-link-cate adv-thumb-link" '.$link_html.'>'.$image_html.'</a>
                   ...
                   <div class="info text-center"><h2 class="info-title  font-semibold title34"><a class="color-white" '.$link_html.'>'.$title_html.'</a></h2><div class="desc title20 color-white">'.$desc_html.'</div><a '.$link_html.' class = "elbzotech-bt-global-style2">'.esc_html__('VIEW NOW','bw-medxtore-v2').'</a></div>';
			?>
		</div>
	<?php } ?>
</div>