        ...
        if(defined('ICL_SITEPRESS_VERSION') && defined('ICL_LANGUAGE_CODE') ){
            ...
            foreach ($wpml_lang as $lang) {
                ...
                if($lang['active']){
                    ...
                    if($flag == 'yes') $lang_active .=  '<img alt="'.esc_attr__("flag",'bw-medxtore-v2').'" src="'.esc_url($flag_url).'">';
                ...
                if($flag == 'yes') $lang_sub .=     '<img alt="'.esc_attr__("flag",'bw-medxtore-v2').'" src="'.esc_url($flag_url).'">';
