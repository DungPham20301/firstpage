...
<div class="main-top-filter">
    ...
    <div class="content-top-filter top-filter flex-wrapper justify_content-space-between align_items-center">
        <div class="main-top-filter__left flex-wrapper align_items-center">
            <div class="open-hide-filters open-hide-filters-desktop"><a href="#" data-textshow = "<?php echo esc_html__('Show Sidebar','bw-medxtore-v2'); ?>"  data-texthide = "<?php echo esc_html__('Hide Sidebar','bw-medxtore-v2'); ?>" class="dropdown-link"><span class="text"><?php echo esc_html__('Hide Sidebar','bw-medxtore-v2'); ?></span><?php echo bzotech_get_icon_svg('hide-filters'); ?></a></div>
            <?php 
            ...
            if($show_number == 'yes'):
                    ...
                    if(!isset($count_query)){
                        $count_query ='';
                         ...
                         $count_query = '<span class="total-count">'.esc_html__(' of ','bw-medxtore-v2').$count_query.'</span>';
                    }
                    ...
                    <div class="show-by elbzotech-dropdown-box">
                        <a href="#" class="dropdown-link"><span class="gray"><?php esc_html_e("Showing: ",'bw-medxtore-v2')?></span><span class="silver number"> <?php echo esc_html((int)$number)?></span><?php echo apply_filters('bzotech_output_content',$count_query); ?></a>
                    ...
                    <div class="view-type">
                        ...
                        if(!empty($column_style_type)){
                            ...
                            for($item = 2; $item <= $column_style_type; $item++){
                                ...
                                if($item  >= 4) $key = 'n';
                                ?>
                                <a data-type="grid" data-col="<?php echo esc_attr($key); ?>" href="<?php echo esc_url(bzotech_get_key_url('type','grid-'.$key.'col'))?>" class="grid-<?php echo esc_attr($key)?> grid-view <?php echo esc_attr($add_class)?> <?php if($style == 'grid-'.$key.'col') echo 'active'?>"><i class="title32 icon-bzo icon-bzo-filter-grid<?php echo esc_attr($key)?>"></i></a>
                                <?php
                            }
                        }?>
                    </div>
