...
if($check_related == '1'):
    ...
    $title_df   = esc_html__("Related Posts",'bw-medxtore-v2');
    ...
    <div class="single-related-post">
    	<h3 class="single-related-post__title title34 font-title color-title text-uppercase">
        ...
        $button_text = esc_html__("Read more", 'bw-medxtore-v2');
