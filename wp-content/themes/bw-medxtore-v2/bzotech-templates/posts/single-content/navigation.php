				...
				<div class="prev-post">
	                ...
	                <h3 class="title14 text-left">
	                	<a href="<?php echo esc_url(get_permalink( $previous_post->ID )); ?>" class=" title18 text-capitalize">
	                		<span class="title font-bold color-title title24"><i class="las la-angle-left"></i><?php echo esc_html__('Previous post','bw-medxtore-v2');?></span>
				...
				<div class="next-post">
	            	...
	            	<h3 class="title14 text-right">
	            		<a href="<?php echo esc_url(get_permalink( $next_post->ID )); ?>" class="  title18   text-capitalize">
	            			<span class="title  font-bold color-title title24"><?php echo esc_html__('Next post','bw-medxtore-v2');?><i class="las la-angle-right"></i></span>
