...
else $title = esc_html__("Blog",'bw-medxtore-v2');
...
if(is_single()) $title = esc_html__("Blog",'bw-medxtore-v2');
if(is_singular('product')) $title = esc_html__("Product",'bw-medxtore-v2');
if(is_search()) $title = esc_html__("Search Result",'bw-medxtore-v2');
