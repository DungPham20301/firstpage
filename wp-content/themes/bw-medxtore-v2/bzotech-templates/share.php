...
if((isset($check_share[$post_type]) && $check_share[$post_type] == '1') || $check_share_page == '1'):
	$list_default = array(
		array(
			'title'  => esc_html__('Total','bw-medxtore-v2'),
		    'social' => 'total',
		    'number' => '1',
			),
		array(
			'title'  => esc_html__('Facebook','bw-medxtore-v2'),
		    'social' => 'facebook',
		    'number' => '1',
			),
		array(
			'title'  => esc_html__('Twitter','bw-medxtore-v2'),
		    'social' => 'twitter',
		    'number' => '1',
			),
		array(
			'title'  => esc_html__('Pinterest','bw-medxtore-v2'),
		    'social' => 'pinterest"',
		    'number' => '1',
			),
		array(
			'title'  => esc_html__('Linkedin','bw-medxtore-v2'),
		    'social' => 'Linkedin',
		    'number' => '1',
			),
		array(
			'title'  => esc_html__('Tumblr','bw-medxtore-v2'),
		    'social' => 'tumblr',
		    'number' => '1',
			),
		array(
			'title'  => esc_html__('Email','bw-medxtore-v2'),
		    'social' => 'envelope',
		    'number' => '1',
			),
		);
...
?>
<?php if(!empty($style) && $style == 'popup') echo '<a href="#" class="popup-share"><i class="icon-bzo icon-bzo-share"><i class="path1"></i></i><span>'.esc_html__('Share','bw-medxtore-v2').'</span></a>';?>
		...
		foreach ($list as $value) {
			...
			switch ($value['social']) { 
				...
				case 'envelope':
					...
					$html_list .='<li><a target="_blank" data-social="'.esc_attr($value['social']).'" title="'.esc_attr($value['title']).'" href="mailto:?subject='.esc_attr__("I wanted you to see this site&amp;body=Check out this site",'bw-medxtore-v2').' '.get_the_permalink().'">
