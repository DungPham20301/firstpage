        ...
        <div class="flex-wrapper">
            ...
            <div class="product-extra-link addcart-link-wrap">
					...
					<div class="product-extra-link__group-extra">
						<?php if(class_exists('YITH_WCWL')) echo bzotech_wishlist_url('',esc_html__('Like','bw-medxtore-v2'));?>
						<?php if($item_quickview == 'yes') bzotech_product_quickview('','<i class="las la-eye"></i>'.esc_html__('Quickview','bw-medxtore-v2'))?>
