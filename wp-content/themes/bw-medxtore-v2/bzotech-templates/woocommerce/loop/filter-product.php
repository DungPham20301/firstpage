...
<div class="filter-product <?php echo esc_attr($filter_style.' '.$filter_column.' '.$filter_pos)?>" data-load="<?php echo esc_attr($data_loadjs);?>" >
    <a href="#" class="btn-filter"><span class="color"><i class="fas fa-search"></i></span><?php esc_html_e("Filter",'bw-medxtore-v2');?></a>
    <div class="box-attr-filter">
        ...
        ?>
            <div class="item-box-attr">
                <div class="item-attr-title">
                    <label><?php esc_html_e("Categories",'bw-medxtore-v2');?></label>
                </div>
        ...
        if($filter_price == 'yes'){
            ...
            <div class="item-box-attr">
                <div class="item-attr-title">
                    <label><?php esc_html_e("Price",'bw-medxtore-v2');?></label>
                </div>
                <div class="item-attr-content range-filter">
                    ...
                    <div class="attr-price-filter">
                        <p>
                            <label><?php esc_html_e("Filter By Price:",'bw-medxtore-v2');?></label>
