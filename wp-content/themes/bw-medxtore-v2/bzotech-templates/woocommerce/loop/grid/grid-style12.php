		...
		<div class="product-info">
			<div class="product-info2">
				...
				<div class="price-brand flex-wrapper align_items-center justify_content-space-between">
					...
					if($item_price == 'yes'){
						if($product->is_on_sale() && ($product->get_type() == 'simple'||$product->get_type() == 'external')) echo '<div class="price-on_sale"><p class="title16 font-semibold main-color">'.esc_html__('Sale Price','bw-medxtore-v2').'</p>';
