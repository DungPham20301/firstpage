                            ...
                            <div class="comments-tab-product-accordion__header align_items-center flex-wrapper flex_wrap-wrap justify_content-space-between align_items-flex-start">
                                <div class="woocommerce-product-rating flex-wrapper flex_wrap-wrap align_items-center total-star">
                                    ...
                                    <?php if ( comments_open() ) : ?>
                                        <?php //phpcs:disable ?>
                                        <a href="#reviews" class="woocommerce-review-link" rel="nofollow">(<?php printf( _n( '%s customer review', '%s customer reviews', $review_count, 'bw-medxtore-v2' ), '<span class="count">' . esc_html( $review_count ) . '</span>' ); ?>)</a>
                                        <?php // phpcs:enable ?>
                                    <?php endif ?>
                                </div>
                                <div><a class="elbzotech-bt-default write-a-review"><i class="las la-pen-fancy"></i><?php echo esc_html__('Write A Review','bw-medxtore-v2'); ?></a></div>
                            </div>
