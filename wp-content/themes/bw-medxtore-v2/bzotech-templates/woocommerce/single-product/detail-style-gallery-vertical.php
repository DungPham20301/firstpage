...
$size_gallery = array(180,180);
$product_gallery_size= bzotech_get_option('product_gallery_size');
if(!empty($product_gallery_size))
$size_gallery = bzotech_get_size_image($size_gallery,$product_gallery_size);
