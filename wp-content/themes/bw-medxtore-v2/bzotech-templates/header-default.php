         ...
         <div class="bzotech-container">
                <div class="flex-wrapper justify_content-space-between align_items-center">
                    <div class="logo-default">
                        <a href="<?php echo esc_url(home_url('/'));?>" title="<?php echo esc_attr__("logo",'bw-medxtore-v2');?>">
                            <?php $bzotech_logo=bzotech_get_option('logo');?>
                            <?php if($bzotech_logo!=''){
                                echo '<h1 class="hidden">'.get_bloginfo('name', 'display').'</h1><img src="' . esc_url($bzotech_logo) . '" alt="'.esc_attr__("logo",'bw-medxtore-v2').'">';
