...
if($query->have_posts()) {
    ...
    ?>
    <div class="wg-product-slider<?php echo esc_attr($style_item); ?>">
                ...
                <div class="swiper-wrapper"> 
                    <?php  while ($query->have_posts()) {
                        ...
                        <div class="swiper-slide">
                            <?php if($style_item=='style2'){
                                ?>
                                <div class="item-product item-product-wg-style2">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <?php 
                                        // bzotech_get_rating_html(true,false);
                                        the_title(' <h3 class="product-title"><a class="color-title" href="'.esc_url(get_the_permalink()).'">','</a></h3>'); 
                                        ?>
